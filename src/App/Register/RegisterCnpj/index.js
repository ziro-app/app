...
export const RegisterCnpj = ({ cnpj, setCnpj, setRazao, setFantasia, setRua, setNumero, setComplemento, setBairro, setCep, setCidade, setEstado, cnpjIsValid, setCnpjIsValid, goForward }) => {
	const [errorCnpj, setErrorCnpj, handleCnpj] = useForm(setCnpj, setCnpjIsValid)
	const [submitting, errorSubmit, submitForm] = useCnpjApi(cnpj, setRazao, setFantasia, setRua, setNumero,
		setComplemento, setBairro, setCep, setCidade, setEstado, setErrorCnpj, cnpjIsValid, setCnpjIsValid, goForward)
	return (	
